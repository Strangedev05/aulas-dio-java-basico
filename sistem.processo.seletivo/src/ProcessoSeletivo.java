...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String candidato) {
        ...
        if(atendeu)
            ...
            System.out.println("NÃO CONSEGUIMOS CONTATO COM " + candidato + ", NÚMERO MÁXIMO DE TENTATIVAS: " + tentativaRealizadas + " TENTATIVAS REALIZADAS");
        }
    ...
    static void imprimirSelecionados() {
        ...
        System.out.println("Imprimindo a lista de candidatos informando o ínidice do elemento");
